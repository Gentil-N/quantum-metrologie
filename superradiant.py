...
def rabi_test():
    ...
    ax1.plot(time_range, qp.expect(rho_spin_up_fock_0, result_1.states), label="|<↑, 0|ψ|↑, 0>|² with Δω = 1 rad/s", color="orange")
    ax1.plot(time_range, qp.expect(rho_spin_down_fock_1, result_1.states), label="|<↓, 1|ψ|↓, 1>|² with Δω = 1 rad/s", color="orange", linestyle="--")
    ax1.plot(time_range, qp.expect(rho_spin_up_fock_0, result_2.states), label="|<↑, 0|ψ|↑, 0>|² with Δω = 3 rad/s", color="red")
    ax1.plot(time_range, qp.expect(rho_spin_down_fock_1, result_2.states), label="|<↓, 1|ψ|↓, 1>|² with Δω = 3 rad/s", color="red", linestyle="--")
