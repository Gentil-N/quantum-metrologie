...
\centering
\includegraphics[width=0.7\textwidth]{detector-fst}
...
\begin{subfigure}{.6\textwidth}
  ...
  \caption{Typical Notch filter's response with $R = 10\Omega$, $C = 1 \quad\textrm{Farad}(F)$ and $L = 1 \quad\textrm{Henry}(H)$.}
  \label{fig:notch-resp}
\end{subfigure}
\caption{Notch filter and its eletrical response.}
\label{fig:test}
\end{figure}
