...
The, applying the spatial evolution operator, one finds (see Annexe ??)
\begin{align}
...
\section{Tavis-Cummings model and open quantum systems}
\paragraph{}

In order to include more atoms, one needs to extend the Hilbert space involved into the JC-model. In fact, there are two ways of coupling more two-level systems, linked to the question: "Are they distinguishable?". Indeed, here is the first \textit{naïve} idea to introduce $N$ atoms:
\begin{align}
\label{dist_sig_1}
