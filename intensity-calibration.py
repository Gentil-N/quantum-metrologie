...
ax2.set_ylabel('Alpha coefficient: Is = α * Itot')
ax.set_xlabel('Amplitude modulation (%)')
...
ax3.set_ylabel("Power difference (43 MHz beat - noise) (dBm)", color="blue")
ax4 = ax3.twinx()
...
ax3.set_xlabel('Amplitude modulation (%)')
ax3.grid()
ax3.set_title("Amplitude modulation variation at minimum total power (0.001µW from the cavity)")
