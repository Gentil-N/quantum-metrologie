...
x_init_ada_order_2 = get_init_vec_ada_order_2(init_state)
x_init_ada_order_3 = get_init_vec_ada_order_3(init_state)
x_init_ada_order_4 = get_init_vec_ada_order_4(init_state)

#print(x_init_order_3)
#exit()

print("Solver started...", end='', flush=True)
solution_order_2 = solve_ivp(correlation_system_ada_order_2, [0.0, 10.0], x_init_ada_order_2, first_step=0.1, max_step=0.1)
solution_order_3 = solve_ivp(correlation_system_ada_order_3, [0.0, 10.0], x_init_ada_order_3, first_step=0.1, max_step=0.1)
solution_order_4 = solve_ivp(correlation_system_ada_order_4, [0.0, 10.0], x_init_ada_order_4, first_step=0.1, max_step=0.1)
print("Done")
...
ax.plot(solution_order_2.t, np.real(solution_order_2.y[8]), label="<n> 2nd", color="yellow", linestyle="-")
ax.plot(solution_order_2.t, np.real(solution_order_2.y[11]), label="<Sz> 2nd", color="yellow")
