...
ax2.plot(power_unb_left, var_unb_left_demod, "+", color="green", label="unbalanced detection (only left diode)")
ax2.plot(power_unb_right, var_unb_right_demod, "+", color="purple", label="unbalanced detection (only right diode)")
ax2.plot(fit_bal[0], fit_bal[1], color="red", label="fit balanced detection")
ax2.plot(fit_unb_left[0], fit_unb_left[1], color="green", label="fit unbalanced detection (only left diode)")
ax2.plot(fit_unb_right[0], fit_unb_right[1], color="purple", label="fit unbalanced detection (only right diode)")
ax2.legend()
ax2.set_xlabel('Power impiging on each diode (mW)')
...
ax3.legend()
ax3.set_xlabel('Power impiging on each diode (mW)')
