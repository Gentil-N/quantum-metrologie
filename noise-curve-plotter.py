...
ax2.plot(power_bal, var_bal_demod, "+", color="red", label="balanced detection")
ax2.plot(power_unb_left, var_unb_left_demod, "+", color="green", label="unbalanced detection (left diode ON)")
ax2.plot(power_unb_right, var_unb_right_demod, "+", color="purple", label="unbalanced detection (right diode ON)")
ax2.plot(fit_bal[0], fit_bal[1], color="red", label="fit balanced detection")
ax2.plot(fit_unb_left[0], fit_unb_left[1], color="green", label="fit unbalanced detection (left diode ON)")
ax2.plot(fit_unb_right[0], fit_unb_right[1], color="purple", label="fit unbalanced detection (right diode ON)")
ax2.legend()
